...
The only requirement is having Node.js and pnpm installed - [install Node.js with nvm](https://github.com/nvm-sh/nvm) and [install pnpm](https://pnpm.io/installation)
...
pnpm start  # then press "i" in the terminal to open iOS Simulator
...
3. Run `pnpm start` and scan the QR code from your development server

### **In your browser**

Run `pnpm start-web` to test in a web browser. Note: The browser preview is great for quick testing, but some native features may not be available.
...
2. Try using tunnel mode: `pnpm start -- --tunnel`
3. Check if your firewall is blocking the connection

### **Build failing?**

1. Clear your cache: `pnpm start -- --clear`
