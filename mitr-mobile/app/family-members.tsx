      ...
      <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
              ...
              <PastelCard key={member.id} color="white" style={styles.memberCard}>
                ...
                <View style={[styles.contactRow, { borderTopColor: colors.borderLight }]}>
                  <View style={styles.contactItem}>
                    ...
                    <Text style={[styles.contactText, { color: colors.textTertiary }]}>{member.email}</Text>
                  </View>
                  <View style={styles.contactItem}>
                    <Phone size={13} color={colors.textTertiary} />
                    <Text style={[styles.contactText, { color: colors.textTertiary }]}>{member.phone}</Text>
                  </View>
                </View>
              </PastelCard>
            ))}
          ...
          >
            ...
            <Text style={[styles.inviteBtnText, { color: colors.surface }]}>Invite family member</Text>
          </TouchableOpacity>
