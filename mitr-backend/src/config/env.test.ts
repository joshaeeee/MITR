  ...
  await withEnv(
    {
      ...
      PIPECAT_GATEWAY_PUBLIC_WS_URL: 'ws://api.mitr.app/ws',
      PIPECAT_GATEWAY_PUBLIC_HTTP_URL: 'http://api.mitr.app',
    ...
    () => {
      assert.throws(() => validateEnv(), /AUTH_DEV_OTP_BYPASS|CORS_ORIGINS|CORS_ALLOW_MISSING_ORIGIN|PIPECAT_GATEWAY_PUBLIC_WS_URL|PIPECAT_GATEWAY_PUBLIC_HTTP_URL/);
    }
  );
});
  ...
  await withEnv(
    {
      ...
      PIPECAT_GATEWAY_PUBLIC_HTTP_URL: 'https://api.mitr.app',
  ...
  await withEnv(
    {
      ...
      PIPECAT_GATEWAY_PUBLIC_WS_URL: 'wss://api.example.com/ws',
      PIPECAT_GATEWAY_PUBLIC_HTTP_URL: 'https://api.example.com',
      INTERNAL_SERVICE_TOKEN: strongInternalToken,
      AUTH_DEV_OTP_BYPASS: 'false',
      AUTH_OTP_DELIVERY_MODE: 'disabled',
      VOICE_NOTES_LOCAL_STORAGE_ACK_RISK: 'true',
    ...
    () => {
      assert.throws(() => validateEnv(), /API_PUBLIC_BASE_URL|PIPECAT_GATEWAY_PUBLIC_WS_URL|PIPECAT_GATEWAY_PUBLIC_HTTP_URL/);
    }
  );
});
